...
export function NewCycleForm() {
  ...
  return (
    <FormContainer>
      ...
      <MinutesAmountInput type="number" id="minutesAmount" disabled={disableWhenActiveCycle} placeholder="00" {...register('minutesAmount', { valueAsNumber: true })} step={5} min={5} max={60} />
